...
from ..agents.core.orchestrator import PBLOrchestrator, OrchestratorMode
...
class AgentService:
    ...
    async def get_agent_metrics(self, session_id: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def _validate_requirements(self, requirements: Dict[str, Any]) -> None:
        ...
        if not isinstance(duration, (str, int, dict)):
            raise ValueError("Duration must be a string, number, or dict with value and unit")
