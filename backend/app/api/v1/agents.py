...
class IterationFeedback(BaseModel):
    ...
    additional_requirements: Dict[str, Any] = Field(default={}, description="New requirements")
...
async def get_system_metrics(
    session_id: Optional[str] = Query(None, description="Optional session ID for specific metrics"),
    current_user: Dict = Depends(get_current_user)
) -> Dict[str, Any]:
    """
            ...
            "agents": [
                {
                    ...
                    "capabilities": ["Framework development", "Theory application", "Learning validation"]
                },
                {
                    "name": "Course Architect",
                    "role": "Designs course structure and learning pathways",
                    "capabilities": ["Module sequencing", "Pathway design", "Milestone planning"]
                },
                {
                    "name": "Content Designer",
                    "role": "Creates engaging educational content and activities",
                    "capabilities": ["Content creation", "Activity design", "Scenario development"]
                },
                {
                    "name": "Assessment Expert",
                    "role": "Develops comprehensive assessment strategies",
                    "capabilities": ["Rubric creation", "Portfolio design", "Feedback systems"]
                },
                {
                    "name": "Material Creator",
                    "role": "Produces ready-to-use educational materials",
                    "capabilities": ["Worksheet creation", "Template design", "Digital resources"]
                }
            ],
            "modes": [
                {
