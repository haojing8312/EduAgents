...
class TemplateDetailResponse(TemplateResponse):
    ...
    def from_orm(cls, template):
        ...
        return cls(**base_data.dict(), template_data=template.template_data or {})
...
class CreateCourseFromTemplateRequest(BaseModel):
    ...
    customizations: Dict[str, Any] = Field(
        default_factory=dict, description="自定义配置"
    )
...
class TemplateStatistics(BaseModel):
    ...
    highest_rated_templates: List[TemplateResponse] = Field(
        ..., description="评分最高模板"
    )
